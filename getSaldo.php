		...
		<div class="container">
			  ...
			  <a class="toggleMenu" href="#"><img src="images/nav_icon.png" alt="" /></a>
				<ul class="nav" id="nav">
				   <li><a href="index.php" class="active">BERANDA</a></li>
					...
					<li><a href="getSaldo.php" class="btn btn-warning">GET SALDO</a></li>
		 ...
		 <div class="header-bottom" id="home">
			<div class="container" style="background: rgba(82, 220, 242, .7);">
				<form action="getSaldo.php" method="post" role="form"style="margin-bottom:20px;">
				...
				<?php
					if($_SERVER['REQUEST_METHOD'] == 'POST'){
						...
						echo "<h2>Saldo Anda: ".$client->getSaldo($npm)."</h2>";
					}
				?>
			</div>
		 </div>
